		...
		*/
			...
			if (structuredScenario.getTitle() != null && !structuredScenario.getTitle().isEmpty()) {
				...
				if (!newTitle.equals(title)) {
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.TITLE.getScenarioElement(), null, 
							QualityPropertyEnum.VAGUENESS.getQualityProperty(), 
							DefectIndicatorEnum.VAGUENESS_INDICATOR.getDefectIndicator(), structuredScenario.getTitle(), indicator, 
							DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.VAGUENESS_INDICATOR.getFixRecomendation());					
			...
			if (structuredScenario.getGoal() != null && !structuredScenario.getGoal().isEmpty()) {
				...
				if (!newGoal.equals(goal)) {
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.GOAL.getScenarioElement(), null, 
							QualityPropertyEnum.VAGUENESS.getQualityProperty(), 
							DefectIndicatorEnum.VAGUENESS_INDICATOR.getDefectIndicator(), structuredScenario.getGoal(), indicator, 
							DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.VAGUENESS_INDICATOR.getFixRecomendation());	
		...
		for(CustomToken token : titleNlp.getTokens()) {
			...
			if (token.getPosTag().equals(PosTagEnum.JJR.name()) || token.getPosTag().equals(PosTagEnum.JJS.name())
				...
				Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.TITLE.getScenarioElement(), null, 
						QualityPropertyEnum.SUBJECTIVENESS.getQualityProperty(), 
						DefectIndicatorEnum.SUBJECTIVENESS_INDICATOR.getDefectIndicator(), structuredScenario.getTitle(), indicator, 
						DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.SUBJECTIVENESS_INDICATOR.getFixRecomendation());	
		...
		for(CustomToken token : goalNlp.getTokens()) {
			...
			if (token.getPosTag().equals(PosTagEnum.JJR.name()) || token.getPosTag().equals(PosTagEnum.JJS.name())
				...
				Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.GOAL.getScenarioElement(), null, 
						QualityPropertyEnum.SUBJECTIVENESS.getQualityProperty(), 
						DefectIndicatorEnum.SUBJECTIVENESS_INDICATOR.getDefectIndicator(), structuredScenario.getGoal(), indicator, 
						DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.SUBJECTIVENESS_INDICATOR.getFixRecomendation());	
		...
		for (String indicator : Unambiguity.OPTION_WORDS_PHRASES) {
			...
			if (structuredScenario.getTitle() != null && !structuredScenario.getTitle().isEmpty()) {
				...
				if (!newTitle.equals(title)) {
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.TITLE.getScenarioElement(), null, 
							QualityPropertyEnum.OPTIONALITY.getQualityProperty(), 
							DefectIndicatorEnum.OPTIONALITY_INDICATOR.getDefectIndicator(), structuredScenario.getTitle(), indicator, 
							DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.OPTIONALITY_INDICATOR.getFixRecomendation());	
			...
			if (structuredScenario.getGoal() != null && !structuredScenario.getGoal().isEmpty()) {
				...
				if (!newGoal.equals(goal)) {
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.GOAL.getScenarioElement(), null, 
							QualityPropertyEnum.OPTIONALITY.getQualityProperty(), 
							DefectIndicatorEnum.OPTIONALITY_INDICATOR.getDefectIndicator(), structuredScenario.getGoal(), indicator, 
							DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.OPTIONALITY_INDICATOR.getFixRecomendation());	
			...
			if(titleNlp != null) {
				for (CustomToken token : titleNlp.getTokens()) {
					if(token.getWord().equals(indicator)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.TITLE.getScenarioElement(), null, 
								QualityPropertyEnum.WEAKNESS.getQualityProperty(), 
								DefectIndicatorEnum.WEAKNESS_INDICATOR.getDefectIndicator(), structuredScenario.getTitle(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.WEAKNESS_INDICATOR.getFixRecomendation());	
			...
			if(goalNlp != null) {
				for (CustomToken token : goalNlp.getTokens()) {
					if(token.getWord().equals(indicator)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.GOAL.getScenarioElement(), null, 
								QualityPropertyEnum.WEAKNESS.getQualityProperty(), 
								DefectIndicatorEnum.WEAKNESS_INDICATOR.getDefectIndicator(), structuredScenario.getGoal(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.WEAKNESS_INDICATOR.getFixRecomendation());	
						defects.add(defect)	;
						break;
					}
		...
		for (String indicator : Unambiguity.IMPLICIT_WORDS_PHRASES) {
			...
			if (structuredScenario.getTitle() != null && !structuredScenario.getTitle().isEmpty()) {
				...
				if (!newTitle.equals(title)) {
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.TITLE.getScenarioElement(), null, 
							QualityPropertyEnum.IMPLICITY.getQualityProperty(), 
							DefectIndicatorEnum.IMPLICITY_INDICATOR.getDefectIndicator(), structuredScenario.getTitle(), indicator, 
							DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.IMPLICITY_INDICATOR.getFixRecomendation());	
		...
		if(goalNlp != null) {
			...
			if(goalNlp.getSubjects() != null && !goalNlp.getSubjects().isEmpty()) {
				...
				if (!strIndicators.isEmpty()) {
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.GOAL.getScenarioElement(), null, 
							QualityPropertyEnum.IMPLICITY.getQualityProperty(), 
							DefectIndicatorEnum.IMPLICITY_INDICATOR.getDefectIndicator(), structuredScenario.getGoal(), strIndicators.toString(), 
							DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.IMPLICITY_INDICATOR.getFixRecomendation());	
		...
		for (String indicator : Unambiguity.QUANTITY_WORDS_PHRASES) {
			if (titleNlp != null) {
				for (CustomToken token : titleNlp.getTokens()) {
					if(token.getWord().equals(indicator)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.TITLE.getScenarioElement(), null, 
								QualityPropertyEnum.QUANTIFIABILITY.getQualityProperty(), 
								DefectIndicatorEnum.QUANTIFIABILITY_INDICATOR.getDefectIndicator(), structuredScenario.getTitle(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.QUANTIFIABILITY_INDICATOR.getFixRecomendation());
			...
			if (goalNlp != null) {
				for (CustomToken token : goalNlp.getTokens()) {
					if(token.getWord().equals(indicator)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.GOAL.getScenarioElement(), null, 
								QualityPropertyEnum.QUANTIFIABILITY.getQualityProperty(), 
								DefectIndicatorEnum.QUANTIFIABILITY_INDICATOR.getDefectIndicator(), structuredScenario.getGoal(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.QUANTIFIABILITY_INDICATOR.getFixRecomendation());
		...
		for (String indicator : Unambiguity.MULTIPLE_WORDS_PHRASES) {
			...
			if (titleNlp != null) {
				for (CustomToken token : titleNlp.getTokens()) {
					if(token.getWord().equals(indicator)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.TITLE.getScenarioElement(), null, 
								QualityPropertyEnum.MULTIPLICITY.getQualityProperty(), 
								DefectIndicatorEnum.MULTIPLICITY_INDICATOR.getDefectIndicator(), structuredScenario.getTitle(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.MULTIPLICITY_INDICATOR.getFixRecomendation());
		...
		for (String indicator : Unambiguity.NON_MINIMAL_WORDS_PHRASES) {
			if (titleNlp != null) {
				for (CustomToken token : titleNlp.getTokens()) {
					if(token.getWord().equals(indicator)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.TITLE.getScenarioElement(), null, 
								QualityPropertyEnum.MINIMALITY.getQualityProperty(), 
								DefectIndicatorEnum.NON_MINIMALITY_INDICATOR.getDefectIndicator(), structuredScenario.getTitle(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.NON_MINIMALITY_INDICATOR.getFixRecomendation());
			...
			if (goalNlp != null) {
				for (CustomToken token : goalNlp.getTokens()) {
					if(token.getWord().equals(indicator)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.GOAL.getScenarioElement(), null, 
								QualityPropertyEnum.MINIMALITY.getQualityProperty(), 
								DefectIndicatorEnum.NON_MINIMALITY_INDICATOR.getDefectIndicator(), structuredScenario.getGoal(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.NON_MINIMALITY_INDICATOR.getFixRecomendation());
		...
		for(StructuredEpisode episode: structuredScenario.getEpisodes()) {
				...
				if (episode.getSentence() != null && !episode.getSentence().isEmpty()) {
					...
					if (!newSentence.equals(sentence)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
								QualityPropertyEnum.VAGUENESS.getQualityProperty(), 
								DefectIndicatorEnum.VAGUENESS_INDICATOR.getDefectIndicator(), episode.getSentence(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.VAGUENESS_INDICATOR.getFixRecomendation());
			...
			if (episodeNlpInfo != null) {
				for(CustomToken token : episodeNlpInfo.getTokens()) {
					...
					if (token.getPosTag().equals(PosTagEnum.JJR.name()) || token.getPosTag().equals(PosTagEnum.JJS.name())
						...
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
								QualityPropertyEnum.SUBJECTIVENESS.getQualityProperty(), 
								DefectIndicatorEnum.SUBJECTIVENESS_INDICATOR.getDefectIndicator(), episode.getSentence(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.SUBJECTIVENESS_INDICATOR.getFixRecomendation());
			...
			for (String indicator : Unambiguity.OPTION_WORDS_PHRASES) {
				...
				if (episode.getSentence() != null && !episode.getSentence().isEmpty()) {
					...
					if (!newSentence.equals(sentence)) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
								QualityPropertyEnum.OPTIONALITY.getQualityProperty(), 
								DefectIndicatorEnum.OPTIONALITY_INDICATOR.getDefectIndicator(), episode.getSentence(), indicator, 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.OPTIONALITY_INDICATOR.getFixRecomendation());
				...
				if(episodeNlpInfo != null) {
					for (CustomToken token : episodeNlpInfo.getTokens()) {
						if(token.getWord().equals(indicator)) {
							Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
									QualityPropertyEnum.WEAKNESS.getQualityProperty(), 
									DefectIndicatorEnum.WEAKNESS_INDICATOR.getDefectIndicator(), episode.getSentence(), indicator, 
									DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.WEAKNESS_INDICATOR.getFixRecomendation());
			...
			if(episodeNlpInfo != null) {
				...
				if(episodeNlpInfo.getSubjects() != null && !episodeNlpInfo.getSubjects().isEmpty()) {
					...
					if (!strIndicators.isEmpty()) {
						Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
								QualityPropertyEnum.IMPLICITY.getQualityProperty(), 
								DefectIndicatorEnum.IMPLICITY_INDICATOR.getDefectIndicator(), episode.getSentence(), strIndicators.toString(), 
								DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.IMPLICITY_INDICATOR.getFixRecomendation());
			...
			if(episodeNlpInfo != null) {
				...
				if(indexQuantityToken >= 0 && indexAdjectiveToken > 0) {
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
							QualityPropertyEnum.QUANTIFIABILITY.getQualityProperty(), 
							DefectIndicatorEnum.QUANTIFIABILITY_INDICATOR.getDefectIndicator(), episode.getSentence(), quantityIndicator + WHITE_SPACE + adjectiveIndicator, 
							DefectCategoryEnum.INFO.getDefectCategory(), DefectIndicatorEnum.QUANTIFIABILITY_INDICATOR.getFixRecomendation());
			...
			if(episodeNlpInfo != null) {
				...
				if(episodeNlpInfo.getSubjects() != null && !episodeNlpInfo.getSubjects().isEmpty() && episodeNlpInfo.getSubjects().size() > 1) {
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
							QualityPropertyEnum.MULTIPLICITY.getQualityProperty(), 
							DefectIndicatorEnum.MULTIPLICITY_SUBJECT_INDICATOR.getDefectIndicator(), episode.getSentence(), episodeNlpInfo.getSubjectsAsString(), 
							DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.MULTIPLICITY_SUBJECT_INDICATOR.getFixRecomendation());
				...
				if(episodeNlpInfo.getMainActionVerbs() != null && !episodeNlpInfo.getMainActionVerbs().isEmpty() && episodeNlpInfo.getMainActionVerbs().entrySet().size() > 1) {
					...
					Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
							QualityPropertyEnum.MULTIPLICITY.getQualityProperty(), 
							DefectIndicatorEnum.MULTIPLICITY_ACTION_VERB_INDICATOR.getDefectIndicator(), episode.getSentence(), episodeNlpInfo.getMainActionVerbsAsString(), 
							DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.MULTIPLICITY_ACTION_VERB_INDICATOR.getFixRecomendation());
				...
				if (episodeNlpInfo != null) {
					for (CustomToken token : episodeNlpInfo.getTokens()) {
						if(token.getWord().equals(indicator)) {
							Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.EPISODE_SENTENCE.getScenarioElement(), episodeId, 
									QualityPropertyEnum.MINIMALITY.getQualityProperty(), 
									DefectIndicatorEnum.NON_MINIMALITY_INDICATOR.getDefectIndicator(), episode.getSentence(), indicator, 
									DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.NON_MINIMALITY_INDICATOR.getFixRecomendation());
						...
						if(solution != null && !solution.isEmpty()) {
							...
							if (!newSentence.equals(lowSolution)) {
								Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
										QualityPropertyEnum.VAGUENESS.getQualityProperty(), 
										DefectIndicatorEnum.VAGUENESS_INDICATOR.getDefectIndicator(), solution, indicator, 
										DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.VAGUENESS_INDICATOR.getFixRecomendation());
					...
					if(solution != null && !solution.isEmpty()) {
						...
						for(CustomToken token : solutionNlpInfo.getTokens()) {
							...
							if (token.getPosTag().equals(PosTagEnum.JJR.name()) || token.getPosTag().equals(PosTagEnum.JJS.name())
								...
								Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
										QualityPropertyEnum.SUBJECTIVENESS.getQualityProperty(), 
										DefectIndicatorEnum.SUBJECTIVENESS_INDICATOR.getDefectIndicator(), solution, indicator, 
										DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.SUBJECTIVENESS_INDICATOR.getFixRecomendation());
					...
					for(String solution : alternative.getSolution()) {
						if(solution != null && !solution.isEmpty()) {
							...
							if (!newSentence.equals(lowSolution)) {
								Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
										QualityPropertyEnum.OPTIONALITY.getQualityProperty(), 
										DefectIndicatorEnum.OPTIONALITY_INDICATOR.getDefectIndicator(), solution, indicator, 
										DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.OPTIONALITY_INDICATOR.getFixRecomendation());
						...
						if(solutionNlpInfo != null) {
							for (CustomToken token : solutionNlpInfo.getTokens()) {
								if(token.getWord().equals(indicator)) {
									Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
											QualityPropertyEnum.WEAKNESS.getQualityProperty(), 
											DefectIndicatorEnum.WEAKNESS_INDICATOR.getDefectIndicator(), solution, indicator, 
											DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.WEAKNESS_INDICATOR.getFixRecomendation());
					...
					if(solutionNlpInfo != null) {
						...
						if(solutionNlpInfo.getSubjects() != null && !solutionNlpInfo.getSubjects().isEmpty()) {
							...
							if (!strIndicators.isEmpty()) {
								Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
										QualityPropertyEnum.IMPLICITY.getQualityProperty(), 
										DefectIndicatorEnum.IMPLICITY_INDICATOR.getDefectIndicator(), solution, strIndicators.toString(), 
										DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.IMPLICITY_INDICATOR.getFixRecomendation());
				...
				if(solution != null && !solution.isEmpty()) {
					...
					if(solutionNlpInfo != null) {
						...
						if(indexQuantityToken >= 0 && indexAdjectiveToken > 0) {
							Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
									QualityPropertyEnum.QUANTIFIABILITY.getQualityProperty(), 
									DefectIndicatorEnum.QUANTIFIABILITY_INDICATOR.getDefectIndicator(), solution, quantityIndicator + WHITE_SPACE + adjectiveIndicator, 
									DefectCategoryEnum.INFO.getDefectCategory(), DefectIndicatorEnum.QUANTIFIABILITY_INDICATOR.getFixRecomendation());
				...
				if(solution != null && !solution.isEmpty()) {
					...
					if(solutionNlpInfo != null) {
						...
						if(solutionNlpInfo.getSubjects() != null && !solutionNlpInfo.getSubjects().isEmpty() && solutionNlpInfo.getSubjects().size() > 1) {
							Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
									QualityPropertyEnum.MULTIPLICITY.getQualityProperty(), 
									DefectIndicatorEnum.MULTIPLICITY_SUBJECT_INDICATOR.getDefectIndicator(), solution, solutionNlpInfo.getSubjectsAsString(), 
									DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.MULTIPLICITY_SUBJECT_INDICATOR.getFixRecomendation());
						...
						if(solutionNlpInfo.getMainActionVerbs() != null && !solutionNlpInfo.getMainActionVerbs().isEmpty() && solutionNlpInfo.getMainActionVerbs().entrySet().size() > 1) {
							Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
									QualityPropertyEnum.MULTIPLICITY.getQualityProperty(), 
									DefectIndicatorEnum.MULTIPLICITY_ACTION_VERB_INDICATOR.getDefectIndicator(), solution, solutionNlpInfo.getMainActionVerbsAsString(), 
									DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.MULTIPLICITY_ACTION_VERB_INDICATOR.getFixRecomendation());
						...
						if(solutionNlpInfo != null) {
							for (CustomToken token : solutionNlpInfo.getTokens()) {
								if(token.getWord().equals(indicator)) {
									Defect defect = NewDefect.buildDefect(structuredScenario.getId(), ScenarioElement.ALTERNATIVE_SOLUTION.getScenarioElement(), alternativeId, 
											QualityPropertyEnum.MINIMALITY.getQualityProperty(), 
											DefectIndicatorEnum.NON_MINIMALITY_INDICATOR.getDefectIndicator(), solution, indicator, 
											DefectCategoryEnum.WARNING.getDefectCategory(), DefectIndicatorEnum.NON_MINIMALITY_INDICATOR.getFixRecomendation());
